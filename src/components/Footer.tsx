        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/company/clinical-research-center-jo" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 hover:bg-primary flex items-center justify-center transition-all duration-300">
              ...
              <a href="https://www.facebook.com/share/1aNEgVgH7r/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 hover:bg-primary flex items-center justify-center transition-all duration-300">
